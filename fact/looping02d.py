...
with open("fact\dnsservers.txt", "r") as dnsfile:   # 'r' is read mode
    ...
    for svr in dnsfile:
        ...
        if svr.endswith('org'):
            with open("fact\org-domain.txt", "a") as srvfile:  # 'a' is append mode
                srvfile.write(svr + "\n")
        # ELSE-IF the string svr ends with 'com'
        elif svr.endswith('com'):
            with open("fact\com-domain.txt", "a") as srvfile:  # 'a' is append mode
                srvfile.write(svr + "\n")

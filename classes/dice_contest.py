...
def main():
    ...
    # played known as weighted player
    weighted_dice = Cheat_Weighted_Dice()
    ...
    while game_number < number_of_games:
        ...
        if sum(weighted_dice.get_dice()) == sum(loaded_dice.get_dice()):
            #print("Draw!")
            pass
        elif sum(weighted_dice.get_dice()) > sum(loaded_dice.get_dice()):
    ...
    print("Final scores")
    print("------------")
    print(f"Swapper won: {loaded_dice_score}")
    print(f"Weighted dice won: {weighted_dice_score}")

    # determine the winner
    if weighted_dice_score == loaded_dice_score:
        print("Game was drawn")
    elif weighted_dice_score > loaded_dice_score:
